...
export type CRON<Value> =
  Split<Value, Space> extends [infer Minute extends string, infer Hour extends string, infer DayOfMonth  extends string, infer Month extends string, infer DayOfWeek extends string] 
